...
router.get("/posts", appointmentDashboardController.getAppointmentDashboardPosts);

router.post("/posts", appointmentDashboardController.createAppointmentDashboardPost);
